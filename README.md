...
| Project | |
|---------|-------------|
| [Wario Style](https://github.com/b1rdmania/motif) · [Live](https://www.wario.style) | Search any song, get the Game Boy version. |
| [ghost-pattern](https://github.com/b1rdmania/ghost-pattern) · [Live](https://ghost-pattern.pages.dev) | Drum patterns from the electronic music canon. Chicago house to UK acid. Play them, mutate them, export to MIDI. |
| [Dig](https://github.com/b1rdmania/dig) · [Live](https://dig-baby-mvp.vercel.app) | The Discogs catalogue rebuilt for 1988-2008 house and techno. Search UI and API. |
| [soundmatch](https://github.com/b1rdmania/soundmatch-audio-finder) | Find royalty-free music by dropping in a song you like. |
